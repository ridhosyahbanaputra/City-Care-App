...
export async function generateSubscribeOptions() {
  return {
...
export async function subscribe() {
  ...
  try {
    ...
    if (!registration || !registration.pushManager) {
      console.error('Push Manager tidak tersedia. Service Worker mungkin gagal terdaftar.');
    ...
    if (!response.ok) {
      ...
      alert(failureSubscribeMessage); // Undo subscribe to push notification
